            ...
            <ul className=" flex justify-center items-center gap-6 cursor-pointer ">
              ...
              <li className=" flex gap-1 items-center relative">
                <span>
                  {/* <PiShoppingCartFill /> */}
                  <span>
                  <svg className="fill-white stroke-slate-600 stroke-2" viewBox="-1 0 37 32" height="25" width="25" fill="#686b78"><path d="M4.438 0l-2.598 5.11-1.84 26.124h34.909l-1.906-26.124-2.597-5.11z"></path></svg>
                  </span>
                  <span className="absolute top-0 left-1 text-sm  font-normal">{cartItems.length}</span>               
                </span>
