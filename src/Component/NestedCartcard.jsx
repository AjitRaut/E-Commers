      ...
      return (
        <div>
          ...
          <div className="flex items-center space-x-4 mb-4">
            <img src={Recomended_IMG_URL + imageId} alt="Restaurant" className="w-12 h-12 rounded" />
            <div>
            ...
            <span>₹{defaultPrice / 100 || price / 100
            }</span>
          </div>
          <div className="mb-4">
          ...
          <div className="mb-4">
            ...
            <div className="flex justify-between">
              ...
              <span>₹{Math.floor(defaultPrice / 100 / 14 || price / 100 / 14)
            }</span>
            </div>
            <div className="flex justify-between">
              <span>Platform Fee</span>
              <span>₹{Math.floor(defaultPrice / 100 / 60 || price / 100 / 60)
            }</span>
            </div>
            <div className="flex justify-between">
              <span>GST</span>
